...
<div class="container mx-auto">
    ...
    <!-- End Hero -->
    <!-- stats -->
    <div class="bg-[#CCD6D4] py-16 sm:py-16 pt-60 px-6 lg:px-8">
    <h2 class="text-center text-4xl font-bold tracking-tight text-[#24565C] sm:text-4xl">LAYANAN KAMI</h2>
    <div class="mt-16 grid grid-cols-1 gap-x-7 gap-y-7 text-center lg:grid-cols-3  lg:mx-[100px]">
        <div class="mx-auto max-w-xs lg:max-w-full lg:flex lg:items-center lg:gap-x-4">
        <img src="{{ asset('img/icon-tour.svg') }}" alt="Vector Image" class="h-[100px] w-[100px] lg:w-auto">
            <div class="mt-4 lg:mt-0 ">
                <h2 class="text-left text-2xl font-bold tracking-tight text-[#24565C]">Tur Pribadi</h2>
                <p class="text-left text-base text-gray-900">Melayani perjalanan khusus untuk membawa anda kemana saja.</p>
            </div>
        </div>
        <div class="mx-auto max-w-xs lg:max-w-full lg:flex lg:items-center lg:gap-x-4">
        <img src="{{ asset('img/icon-briefcase.svg') }}" alt="Vector Image" class="h-[100px] w-[100px] lg:w-auto">
            <div class="mt-4 lg:mt-0 ">
                <h2 class="text-left text-2xl font-bold tracking-tight text-[#24565C]">Tur Antar Kota</h2>
                <p class="text-left text-base text-gray-900">Menyediakan tur Antar kota Malang-Juanda / Jawa-Bali.</p>
            </div>
        </div>
        <div class="mx-auto max-w-xs lg:max-w-full lg:flex lg:items-center lg:gap-x-4">
        <img src="{{ asset('img/icon-car.svg') }}" alt="Vector Image" class="h-[100px] w-[100px] lg:w-auto">
            <div class="mt-4 lg:mt-0 ">
                <h2 class="text-left text-2xl font-bold tracking-tight text-[#24565C]">Sewa Kendaraan</h2>
    ...
    <h2 class="text-center text-4xl font-bold tracking-tight text-[#24565C] sm:text-4xl">DESTINASI POPULER</h2>
    ...
    <div class="mt-16 grid grid-cols-1 gap-x-7 gap-y-7 text-center lg:grid-cols-4  lg:mx-[100px]">
    
    <div class="relative max-w-xs lg:max-w-full bg-white rounded-lg shadow-lg overflow-hidden lg:flex lg:items-center lg:gap-x-4 h-[400px]">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <h3 class="text-3xl font-bold text-white">BROMO</h3>
        </div>
    </div>
    <div class="relative max-w-xs lg:max-w-full bg-white rounded-lg shadow-lg overflow-hidden lg:flex lg:items-center lg:gap-x-4 h-[400px]">
        <img src="{{ asset('img/bg-bromo.jpg') }}" alt="Popular Destination" class="absolute inset-0 w-full h-full object-cover">
